...
with open('preprocessed_tgv_data.csv', 'rb') as f:
...
df = pd.read_csv('preprocessed_tgv_data.csv', engine='c', sep=';', usecols=colonnes_a_inclure, encoding=result['encoding'])
...
# Vous pouvez aussi afficher les prédictions et les vraies valeurs pour une comparaison visuelle
